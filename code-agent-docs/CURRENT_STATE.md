...
- **Active task:** none (S01.2-T05 done; S01.2-T06 next)

## In progress (write-ahead)
- S01.2-T05: push, wait for CI, merge `feat/S01.2-T05-health` into `develop`.
...
- **S01.2-T05 done** (S005 E050): health checks config, storage_writable, same_filesystem (warn + upload_finalize_mode=copy on a split), free_space, database; run at startup and on the health endpoint.
