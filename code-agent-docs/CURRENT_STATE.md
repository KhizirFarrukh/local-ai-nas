...
- **Active task:** none (S01.3-T03 done; S01.3-T04 next)

## In progress (write-ahead)
- S01.3-T03: push, CI, merge `feat/S01.3-T03-details` into `develop`.
...
- **S01.3-T03 done** (S005 E070): item details with MIME (extension, else sniff) and a strong ETag (size + mtime + file ID) that changes on rewrite and on replacement.
